...
- changing ‘precipitationCal’ variable to ‘precipitation’ in accordance
  with GPM Version 07
...
- Adding getPass library in Imports. Addressing curl Certificate
  Verification for NEX-GDDP.
...
- Adding Near Real Time GPM function with latency as one day. Fixing
  CMIP5 and CMIP6 server access.
...
- Released on 2021-July-12. Handling of GLDAS dimension order change for
  2021 data products.
