...
```{r, fig.alt="GLDAS data grids that fall within the boundaries of the White Oak Bayou watershed"}
library(ggplot2)
library(tidyterra)
ggplot(shape) + 
...
```{r, fig.alt="A pseudo air temperature gauge located at the centroid of the White Oak Bayou watershed"}
library(ggplot2)
library(tidyterra)
