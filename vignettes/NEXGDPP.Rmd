---
title: "Getting started with NEXGDPP-CMIP5 data"
...
vignette: >
  %\VignetteIndexEntry{Getting started with NEXGDPP-CMIP5 data}
...
NEX_GDPP_CMIP5(Dir = "./NEX_GDPP_CMIP5/", 
...
```{r}
NEX_GDPP.precipitationMaster <- system.file('extdata/NEX_GDPP_CMIP5',
                                         'prGrid_Master.txt', 
                                         package = 'NASAaccess')

NEX_GDPP_CMIP5.table<-read.csv(NEX_GDPP.precipitationMaster)

head(NEX_GDPP_CMIP5.table)

dim(NEX_GDPP_CMIP5.table)
```
...
Changing `type` parameter in the `NEX_GDPP_CMIP5` function from `pr` to `tas` gives us minimum and maximum air temperatures.
