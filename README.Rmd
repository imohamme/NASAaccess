...
On a local machine the user should have installed the following programs as well as setting up a user account.  The list below gives a summary of what is needed to be done prior to work with NASAaccess software on any local machine:
  ...
  + Installing [*curl*](https://curl.haxx.se/) software .  Since Mac users have [*curl*](https://curl.haxx.se/) as part of macOS build, Windows users should make sure that their local machines build have [*curl*](https://curl.haxx.se/) installed properly.
  
  + Checking if you can run [*curl*](https://curl.haxx.se/) from your command prompt.  Type `curl --help` and you should see the help pages for the [*curl*](https://curl.haxx.se/) program once everything is defined correctly.
